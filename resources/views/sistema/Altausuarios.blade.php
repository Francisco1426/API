  ...
  <body>
    <div id="contenedor-form">
      <form action="#" method="post" onsubmit="return validar()">
        ...
        <p class="password">
          <textarea class="input" id="password" placeholder="Password" name="password" onblur="revisar(this); revisaLongitud(this, 6)" onkeyup="revisar(this); revisaLongitud(this, 6)" autocomplete="off" required></textarea>
        </p>
